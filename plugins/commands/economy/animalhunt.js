...
const langData = {
  "en_US": {
    ...
    "animalhunt.successTreasure": "𝚈𝚘𝚞 𝚍𝚒𝚜𝚌𝚘𝚟𝚎𝚛𝚎𝚍 𝚊 𝚝𝚛𝚎𝚊𝚜𝚞𝚛𝚎 𝚌𝚑𝚎𝚜𝚝 𝚠𝚘𝚛𝚝𝚑 𝟻𝟶𝟶𝟶𝟶! 💰",
...
async function onCall({ message, args, extra, getLang }) {
  ...
  try {
    ...
    if (userMoney < bet) return message.reply(getLang("animalhunt.notEnoughMoney"));
    if (bet < extra.minbet) return message.reply(getLang("animalhunt.minMoney", { min: extra.minbet }));
